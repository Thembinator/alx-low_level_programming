...
11.
11. Write a keygen for crackme5, The crackme will segfault if you do not enter the correct key for the user,  keygen should print a valid key for the username.
